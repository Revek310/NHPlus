...
public class SetUpDB {
    ...
    /**
     * fills the patient table with entries
     */
    private static void setUpPatients() {
        try {
            PatientDao dao = DaoFactory.getDaoFactory().createPatientDAO();
            dao.create(new Patient("Seppl", "Herberger", convertStringToLocalDate("1945-12-01"), "4", "202","", convertStringToLocalDate("2000-03-07")));
            dao.create(new Patient("Martina", "Gerdsen", convertStringToLocalDate("1954-08-12"), "5", "010","", convertStringToLocalDate("2000-03-07")));
            dao.create(new Patient("Gertrud", "Franzen", convertStringToLocalDate("1949-04-16"), "3", "002","", convertStringToLocalDate("2000-03-07")));
            dao.create(new Patient("Ahmet", "Yilmaz", convertStringToLocalDate("1941-02-22"), "3", "013","x", convertStringToLocalDate("2000-03-07")));
            dao.create(new Patient("Hans", "Neumann", convertStringToLocalDate("1955-12-12"), "2", "001","x", convertStringToLocalDate("2000-03-07")));
            dao.create(new Patient("Elisabeth", "Müller", convertStringToLocalDate("1958-03-07"), "5", "110","x",convertStringToLocalDate("2000-03-07")));
        } catch (SQLException exception) {
    ...
    /**
     * fills the caregiver table with entries
     */
    private static void setUpCaregiver() {
        try {
            CaregiverDao dao = DaoFactory.getDaoFactory().createCaregiverDAO();
            dao.create(new Caregiver("Seppl", "Herberger",  "44573473", "admin", "admin",""));
            dao.create(new Caregiver("Martina", "Gerdsen", "5457457754","UwU","OwO",""));
 } catch (SQLException exception) {
            exception.printStackTrace();
        }
    }
    ...
    /**
     * fills the treatment table with entries
     */
    private static void setUpTreatments() {
        try {
            ...
            dao.create(new Treatment(4, 1, convertStringToLocalDate("2023-06-06"), convertStringToLocalTime("15:10"), convertStringToLocalTime("16:00"), "Spaziergang", "Spaziergang im Park, Patient döst  im Rollstuhl ein",1));
            ...
            dao.create(new Treatment(9, 2, convertStringToLocalDate("2023-06-07"), convertStringToLocalTime("11:00"), convertStringToLocalTime("11:30"), "Waschen", "Waschen per Dusche auf einem Stuhl; Patientin gewendet;",1));
            ...
            dao.create(new Treatment(14, 4, convertStringToLocalDate("2023-08-24"), convertStringToLocalTime("09:30"), convertStringToLocalTime("10:15"), "KG", "Lympfdrainage",1));
            dao.create(new Treatment(16, 6, convertStringToLocalDate("2023-08-31"), convertStringToLocalTime("13:30"), convertStringToLocalTime("13:45"), "Toilettengang", "Hilfe beim Toilettengang; Patientin klagt über Schmerzen beim Stuhlgang. Gabe von Iberogast",1));
            dao.create(new Treatment(17, 6, convertStringToLocalDate("2023-09-01"), convertStringToLocalTime("16:00"), convertStringToLocalTime("17:00"), "KG", "Massage der Extremitäten zur Verbesserung der Durchblutung",1));
        } catch (SQLException exception) {
            exception.printStackTrace();
        }
    }
